...
!>                          | = 0 CLDZ is computed with original algorithm (convective + grid-scale; Ferrier, Feb '02)
!>                          | = 1 (default) CLDZ is computed with GSD legacy cloud ceiling alrorithm (used for field 408)
!-----------------------------------------------------------------------
...
!> Logicals to turn on/off different post-processing packages/output depending on model output.
  ...
  integer :: i_cch260_rtma = 1       !< using GSD legacy cloud ceiling algorithm to compute cloud base height for field 260 (only used for 3DRTMA)
!
